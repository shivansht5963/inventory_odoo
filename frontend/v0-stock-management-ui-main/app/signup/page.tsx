      ...
      >
        <Card className="sketchy-border hand-drawn-shadow border-4 border-purple-600 bg-white p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-amber-900 text-sm font-medium">Create Your Account</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label className="font-sans text-lg font-bold text-gray-800">Full Name</Label>
              <Input
                type="text"
            ...
            <div className="space-y-2">
              <Label className="font-sans text-lg font-bold text-gray-800">Confirm Password</Label>
              <Input
                type="password"
                placeholder="••••••••"
          ...
          <div className="text-center mt-6">
            <p className="font-sans text-gray-700">
              ...
              <Link href="/login" className="text-purple-600 font-bold underline hover:text-purple-700">
                Sign In
              </Link>
            </p>
          </div>
